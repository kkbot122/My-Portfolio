...
function CursorProvider({ ref, children, ...props }: CursorProviderProps) {
  ...
  return (
    <CursorContext.Provider
      value={{ cursorPos, isActive, cursorRef }}
    >
    ...
    <AnimatePresence>
      {isActive && (
        <motion.div
          ...
          data-slot="cursor"
          className={cn(
            'transform-[translate(-50%,-50%)] pointer-events-none z-[9999] fixed', // Changed to fixed
            className,
          )}
    ...
    <AnimatePresence>
      {isActive && (
        <motion.div
          ...
          className={cn(
            'transform-[translate(-50%,-50%)] pointer-events-none z-[9998] fixed', // Changed to fixed
            className,
          )}
